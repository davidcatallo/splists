...
<div class="container-fluid mt-2">
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="ml-2">
                        <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#formList">Nouvelle
                            liste</button>
                    </li>
                </ul>
            </div>
        ...
        <!-- main ticjets appartenants à une liste -->
